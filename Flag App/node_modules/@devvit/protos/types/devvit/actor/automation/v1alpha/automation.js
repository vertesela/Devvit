...
export const AutomationEngineServiceName = "devvit.actor.automation.v1alpha.AutomationEngine";
export class AutomationEngineClientImpl {
    constructor(rpc, opts) {
        this.service = opts?.service || AutomationEngineServiceName;
        this.rpc = rpc;
    ...
    Evaluate(request, metadata) {
        ...
        return promise.then((data) => AutomationResult.decode(_m0.Reader.create(data)));
    }
}
