 ...
 */
export function getConversationSortDate(conversation, sort, defaultDate = 0) {
    switch (sort) {
        case "recent":
 ...
 */
export function getLastConversation(conversations, sort) {
    let oldest;
 ...
 */
export function sortConversations(conversations, sort) {
 ...
 */
export async function getModmailConversations(modmail, options) {
    ...
    while (conversations.length < options.limit) {
        try {
            ...
            const newConversations = sortConversations(Object.values(response.conversations).filter(conversation => conversation.id && !seenConversationIds.has(conversation.id)), options.sort);
 ...
 */
export function getModmailPermalink(conversation, message) {
    let conversationId = "";
    let messageId = "";
