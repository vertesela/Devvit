import type { LogErrorMessage, LogErrorResponse, LogEventResponse, Logger, LogMessage, LogMessages, LogResponse } from '@devvit/protos';
...
export declare class ConsoleLogger implements Logger {
    ...
    LogBatch(logs: LogMessages): Promise<LogResponse>;
}
