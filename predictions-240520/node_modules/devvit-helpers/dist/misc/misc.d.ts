 ...
 */
export declare function domainFromUrlString(url: string, defaultValue?: string): string;
/**
 ...
 */
export declare function printEach(func: (message: unknown) => void, array: unknown[]): void;
/**
 ...
 */
export declare function stringSplitter(str: string, maxLen: number): string[];
