 ...
 */
export declare function replacePlaceholders(text: string, placeholders: Placeholder[]): string;
/**
 *
 ...
 */
export declare function assembleRemovalReason(template: RemovalReasonTemplate, placeholders: Placeholder[], placeholderRecord?: Record<string, string>): string;
/**
 ...
 */
export declare function placeholdersFromRecord(record: Record<string, string>): Placeholder[];
/**
...
export type PlaceholderGetters<PlaceholderKeys extends string, DataSource> = {
    [key in PlaceholderKeys]: DataSource extends object & {
        customDateformat?: CustomDateformat;
    } ? TypeToStringAsync<DataSource & {
        customDateformat?: CustomDateformat;
    }> : TypeToStringAsync<DataSource>;
};
/**
 ...
 */
export declare function getPlaceholdersFromGetters<PlaceholderKeys extends string, DataSource>(placeholderGetters: PlaceholderGetters<PlaceholderKeys, DataSource>, arg: DataSource): Promise<Placeholder[]>;
