...
import { isNativeWorker, isPlatformNode, isWorker } from '@devvit/shared-types/PlatformUtil.js';
...
_CentralDispatcher_clients = new WeakMap(), _CentralDispatcher_recipientsByHostname = new WeakMap(), _CentralDispatcher_supervisor = new WeakMap(), _CentralDispatcher_streamsByID = new WeakMap(), _CentralDispatcher_instances = new WeakSet(), _CentralDispatcher_bind = function _CentralDispatcher_bind(recipient) {
    ...
    // to-do: simplify. This calculation is complicated because in the now
    // deleted BrowserRuntime main thread, the dispatcher's hostname is usually
    // "local". Workers, however, are special and their dispatchers have the
    // same hostname as their actors.
    //
    ...
    const isCommonRuntime = !isWorker() && isPlatformNode();
