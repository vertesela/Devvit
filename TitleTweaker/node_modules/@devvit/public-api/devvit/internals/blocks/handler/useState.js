...
class AsyncStateHook {
    ...
    onLoad(renderContext) {
        if (this.state.value === null && !this.state.loading) {
            ...
            __classPrivateFieldGet(this, _AsyncStateHook_changed, "f").call(this);
            renderContext.emitEffect(__classPrivateFieldGet(this, _AsyncStateHook_hookId, "f"), {
                type: EffectType.EFFECT_SEND_EVENT,
                // This is on the main queue, because it blocks app load.
                sendEvent: { event: { asyncRequest: { requestId: __classPrivateFieldGet(this, _AsyncStateHook_hookId, "f") }, hook: __classPrivateFieldGet(this, _AsyncStateHook_hookId, "f") } },
            });
