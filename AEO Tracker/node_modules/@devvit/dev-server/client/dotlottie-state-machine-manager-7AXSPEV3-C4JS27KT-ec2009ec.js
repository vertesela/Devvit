...
var X = (e, t, n) => (Oe(e, typeof t != "symbol" ? t + "" : t, n), n);
import { g as It, n as Ht, $ as ke, t as Te } from "./index-f1a89dfb.js";
var p = function() {
...
var Mt = N.Start, Ft = N.Stop, yt = N.Raise, jt = N.Send, re = N.Cancel, Ae = N.NullEvent, oe = N.Assign;
N.After;
N.DoneState;
var ae = N.Log, Pe = N.Init, Ct = N.Invoke;
N.ErrorExecution;
var Yt = N.ErrorPlatform, je = N.ErrorCustom, se = N.Update, Ne = N.Choose, Ie = N.Pure, ce = ".", Zt = {}, Rt = "xstate.guard", Le = "", Lt;
function Xt(e, t, n) {
  n === void 0 && (n = ce);
  var i = dt(e, n), r = dt(t, n);
  return j(r) ? j(i) ? r === i : !1 : j(i) ? i in r : Object.keys(i).every(function(o) {
...
function bt(e) {
  ...
  if (j(e))
    return [[e]];
  var t = D(Object.keys(e).map(function(n) {
    var i = e[n];
    return typeof i != "string" && (!i || !Object.keys(i).length) ? [[n]] : bt(e[n]).map(function(r) {
      return [n].concat(r);
    });
  }));
  return t;
...
function le(e, t) {
  return ut(e.states, function(n, i) {
    if (n) {
      var r = (j(t) ? void 0 : t[i]) || (n ? n.current : void 0);
      if (r)
...
function fe(e, t) {
  if (e)
    return j(e) ? { type: Rt, name: e, predicate: t ? t[e] : void 0 } : T(e) ? { type: Rt, name: e.name, predicate: e } : e;
}
function Je(e) {
  try {
...
function Nt(e, t) {
  return j(e) || typeof e == "number" ? p({ type: e }, t) : e;
}
function R(e, t) {
  if (!j(e) && "$$type" in e && e.$$type === "scxml")
    return e;
  var n = Nt(e);
  return p({ name: n.type, data: n, $$type: "scxml", type: "external" }, t);
}
function Z(e, t) {
  var n = he(t).map(function(i) {
    return typeof i > "u" || typeof i == "string" || ot(i) ? { target: i, event: e } : p(p({}, i), { event: e });
  });
  return n;
}
function qe(e) {
...
function $t(e) {
  return (e.type === yt || e.type === jt && e.to === rt.Internal) && typeof e.delay != "number";
}
var it = R({ type: Pe });
function zt(e, t) {
  return t && t[e] || void 0;
...
function Qt(e) {
  var t = vt(e);
  return p(p({ id: j(e) ? e : t.id }, t), { type: t.type });
}
function Fe(e, t) {
  return { type: yt, event: typeof e == "function" ? e : Nt(e), delay: t ? t.delay : void 0, id: t == null ? void 0 : t.id };
}
function Xe(e, t, n, i) {
  ...
  return p(p({}, e), { type: yt, _event: o, delay: a });
}
function Qe(e, t) {
  return { to: t ? t.to : void 0, type: jt, event: T(e) ? e : Nt(e), delay: t ? t.delay : void 0, id: t && t.id !== void 0 ? t.id : T(e) ? e.name : ue(e) };
}
function Ge(e, t, n, i) {
  var r = { _event: n }, o = R(T(e.event) ? e.event(t, n.data, r) : e.event), a;
  if (j(e.delay)) {
...
var We = function(e, t, n) {
  return p(p({}, e), { value: j(e.expr) ? e.expr : e.expr(t, n.data, { _event: n }) });
}, He = function(e) {
  return { type: re, sendId: e };
};
function Ye(e) {
  var t = Qt(e);
...
function Ke(e, t, n) {
  var i = T(e.activity) ? e.activity(t, n.data) : e.activity, r = typeof i == "string" ? { id: i } : i, o = { type: N.Stop, activity: r };
  return o;
}
function tn(e, t) {
  var n = t ? "#".concat(t) : "";
  return "".concat(N.After, "(").concat(e, ")").concat(n);
}
function xt(e, t) {
  var n = "".concat(N.DoneState, ".").concat(e), i = { type: n, data: t };
  return i.toString = function() {
    return n;
  }, i;
}
function Et(e, t) {
  var n = "".concat(N.DoneInvoke, ".").concat(e), i = { type: n, data: t };
  return i.toString = function() {
    return n;
  }, i;
}
function ht(e, t) {
  var n = "".concat(N.ErrorPlatform, ".").concat(e), i = { type: n, data: t };
  return i.toString = function() {
    return n;
  }, i;
}
...
function At(e, t, n, i, r, o, a) {
  a === void 0 && (a = !1);
  var s = a ? [] : en(r), c = s.length ? ee(n, i, s, t) : n, u = a ? [n] : void 0, h = [];
  function f(y, v) {
    var x;
    switch (v.type) {
      case yt: {
        var g = Xe(v, c, i, e.options.delays);
      ...
      case ae: {
        var _ = We(v, c, i);
        return o == null || o(_, c, i), _;
      }
      case Ne: {
        var b = v, A = (x = b.conds.find(function(gt) {
          var q = fe(gt.cond, e.options.guards);
          return !q || de(e, q, c, i, o ? void 0 : t);
        })) === null || x === void 0 ? void 0 : x.actions;
        if (!A)
          return [];
        var L = O(At(e, t, c, i, [{ type: y, actions: G(U(A), e.options.actions) }], o, a), 2), k = L[0], I = L[1];
        return c = I, u == null || u.push(c), k;
      }
      case Ie: {
        var A = v.get(c, i.data);
        if (!A)
          return [];
        var w = O(At(e, t, c, i, [{ type: y, actions: G(U(A), e.options.actions) }], o, a), 2), M = w[0], S = w[1];
        return c = S, u == null || u.push(c), M;
      }
      case Ft: {
        var _ = Ke(v, c, i);
        return o == null || o(_, n, i), _;
      }
      case oe: {
        c = ee(c, i, [v], o ? void 0 : t), u == null || u.push(c);
        break;
      }
      default:
        var P = vt(v, e.options.actions), B = P.exec;
        if (o)
          o(P, c, i);
        else if (B && u) {
          var $ = u.length - 1, st = p(p({}, P), { exec: function(gt) {
            for (var q = [], W = 1; W < arguments.length; W++)
              q[W - 1] = arguments[W];
            B.apply(void 0, V([u[$]], O(q), !1));
          } });
          P = st;
        }
        return P;
...
function nn(e, t, n, i) {
  var r, o = ve(e.src), a = (r = t == null ? void 0 : t.options.services) === null || r === void 0 ? void 0 : r[o.type], s = e.data ? Tt(e.data, n, i) : void 0, c = a ? ye(a, e.id, s) : pe(e.id);
  return c.meta = e, c;
}
function ye(e, t, n) {
  var i = pe(t);
...
function me(e) {
  var t = [e];
  return Pt(e) ? t : t.concat(D(pt(e).map(me)));
}
function lt(e, t) {
  var n, i, r, o, a, s, c, u, h = new Set(e), f = Jt(h), l = new Set(t);
  try {
    for (var d = E(l), y = d.next(); !y.done; y = d.next())
      for (var v = y.value, x = v.parent; x && !l.has(x); )
        l.add(x), x = x.parent;
  } catch (w) {
    n = { error: w };
  } finally {
  ...
  try {
    for (var m = E(l), _ = m.next(); !_.done; _ = m.next()) {
      ...
      if (v.type === "compound" && (!g.get(v) || !g.get(v).length))
        ...
        try {
          for (var b = (a = void 0, E(pt(v))), A = b.next(); !A.done; A = b.next()) {
            var L = A.value;
            l.has(L) || (l.add(L), f.get(L) ? f.get(L).forEach(function(M) {
              return l.add(M);
            }) : L.initialStateNodes.forEach(function(M) {
              return l.add(M);
            }));
          }
        } catch (M) {
  ...
  try {
    for (var k = E(l), I = k.next(); !I.done; I = k.next())
      for (var v = I.value, x = v.parent; x && !l.has(x); )
        l.add(x), x = x.parent;
  } catch (w) {
    c = { error: w };
  } finally {
...
function cn(e) {
  return V([], O(new Set(D(V([], O(e.map(function(t) {
    return t.ownEvents;
  })), !1)))), !1);
}
function Ot(e, t) {
...
function ne(e) {
  return new Set(D(e.map(function(t) {
    return t.tags;
  })));
}
function _e(e, t) {
...
var F = function() {
  ...
  return e.from = function(t, n) {
    ...
    var n = t.tags;
    t.machine;
    var i = qt(t, ["configuration", "transitions", "tags", "machine"]);
...
}(), fn = { deferEvents: !1 }, ie = function() {
  function e(t) {
    this.processingEvent = !1, this.queue = [], this.initialized = !1, this.options = p(p({}, fn), t);
  }
...
}(), Vt = /* @__PURE__ */ new Map(), dn = 0, ct = { bookId: function() {
  return "x:".concat(dn++);
...
function yn(e, t) {
  t === void 0 && (t = {});
  var n = e.initialState, i = /* @__PURE__ */ new Set(), r = [], o = !1, a = function() {
    if (!o) {
      for (o = !0; r.length > 0; ) {
        var u = r.shift();
...
var mn = function() {
  function e(t, n) {
    ...
    var i = this;
    this.machine = t, this.delayedEventsMap = {}, this.listeners = /* @__PURE__ */ new Set(), this.contextListeners = /* @__PURE__ */ new Set(), this.stopListeners = /* @__PURE__ */ new Set(), this.doneListeners = /* @__PURE__ */ new Set(), this.eventListeners = /* @__PURE__ */ new Set(), this.sendListeners = /* @__PURE__ */ new Set(), this.initialized = !1, this.status = C.NotStarted, this.children = /* @__PURE__ */ new Map(), this.forwardTo = /* @__PURE__ */ new Set(), this._outgoingQueue = [], this.init = this.start, this.send = function(h, f) {
      if (at(h))
        return i.batch(h), i.state;
      var l = R(Nt(h, f));
      if (i.status === C.Stopped)
        return i.state;
      if (i.status !== C.Running && !i.options.deferEvents)
...
Event: `).concat(JSON.stringify(l.data)));
      ...
      var d = i.parent && (f === rt.Parent || i.parent.id === f), y = d ? i.parent : j(f) ? f === rt.Internal ? i : i.children.get(f) || ct.get(f) : Ue(f) ? f : void 0;
      if (!y) {
        if (!d)
      ...
      if ("machine" in y) {
        if (i.status !== C.Stopped || i.parent !== y || i.state.done) {
          var v = p(p({}, h), { name: h.name === je ? "".concat(ht(i.id)) : h.name, origin: i.sessionId });
      ...
      switch (h.type) {
        ...
        case jt:
          ...
          if (typeof g.delay == "number") {
            ...
            g.to ? i.sendTo(g._event, g.to, l === it) : i.send(g._event);
          break;
        case re:
          i.cancel(h.sendId);
          break;
        case Mt: {
          if (i.status !== C.Running)
            return;
          var m = h.activity;
          if (!i.machine.config.predictableActionArguments && !i.state.activities[m.id || m.type])
            break;
          if (m.type === N.Invoke) {
            var _ = ve(m.src), b = i.machine.options.services ? i.machine.options.services[_.type] : void 0, A = m.id, L = m.data, k = "autoForward" in m ? m.autoForward : !!m.forward;
            if (!b)
              return;
            var I = L ? Tt(L, f, l) : void 0;
            if (typeof b == "string")
              return;
            var w = T(b) ? b(f, l.data, { data: I, src: _, meta: m.meta }) : b;
            if (!w)
              return;
            var M = void 0;
            ot(w) && (w = I ? w.withContext(I) : w, M = { autoForward: k }), i.spawn(w, A, M);
          } else
            i.spawnActivity(m);
          break;
        }
        ...
        case ae:
          var S = h, P = S.label, B = S.value;
          P ? i.logger(P, B) : i.logger(B);
          break;
      }
    };
    var r = p(p({}, e.defaultOptions), n), o = r.clock, a = r.logger, s = r.parent, c = r.id, u = c !== void 0 ? c : t.id;
    this.id = u, this.logger = a, this.clock = o, this.parent = s, this.options = r, this.scheduler = new ie({ deferEvents: this.options.deferEvents }), this.sessionId = ct.bookId();
  }
  return Object.defineProperty(e.prototype, "initialState", { get: function() {
    ...
    return this._state;
  }, enumerable: !1, configurable: !0 }), e.prototype.execute = function(t, n) {
    var i, r;
    try {
    ...
    if (t._sessionid = this.sessionId, this._state = t, (!this.machine.config.predictableActionArguments || n === it) && this.options.execute)
    ...
    try {
      for (var x = E(this.listeners), g = x.next(); !g.done; g = x.next()) {
        var v = g.value;
        v(t, t.event);
      }
    } catch (w) {
    ...
    if (this.state.done) {
      var A = t.configuration.find(function(w) {
        return w.type === "final" && w.parent === f.machine;
      }), L = A && A.doneData ? Tt(A.doneData, t.context, n) : void 0;
      this._doneEvent = Et(this.id, L);
      try {
        for (var k = E(this.doneListeners), I = k.next(); !I.done; I = k.next()) {
          var v = I.value;
          v(this._doneEvent);
        }
      } catch (w) {
    ...
    return this.listeners.add(t), this.status === C.Running && t(this.state, this.state.event), this;
  }, e.prototype.subscribe = function(t, n, i) {
    var r = this, o = wt(t, n, i);
    this.listeners.add(o.next), this.status !== C.NotStarted && o.next(this.state);
    var a = function() {
      r.doneListeners.delete(a), r.stopListeners.delete(a), o.complete();
    };
    return this.status === C.Stopped ? o.complete() : (this.onDone(a), this.onStop(a)), { unsubscribe: function() {
    ...
    return this.status === C.Stopped && this._doneEvent ? t(this._doneEvent) : this.doneListeners.add(t), this;
    ...
    var n = this;
    if (this.status === C.Running)
      return this;
    this.machine._init(), ct.register(this.sessionId, this), this.initialized = !0, this.status = C.Running;
    var i = t === void 0 ? this.initialState : et(this, function() {
      return hn(t) ? n.machine.resolveState(t) : n.machine.resolveState(F.from(t, n.machine.context));
    });
    ...
    try {
      for (var x = E(this.contextListeners), g = x.next(); !g.done; g = x.next()) {
        var d = g.value;
    ...
    if (!this.initialized)
      return this;
    this.initialized = !1, this.status = C.Stopped, this._initialState = void 0;
    try {
      for (var b = E(Object.keys(this.delayedEventsMap)), A = b.next(); !A.done; A = b.next()) {
        var L = A.value;
    ...
    var n = this;
    if (!(this.status === C.NotStarted && this.options.deferEvents) && this.status !== C.Running)
    ...
    var i = this;
    n === void 0 && (n = {});
    var r = new e(t, p(p({}, this.options), { parent: this, id: n.id || t.id })), o = p(p({}, gn), n);
    o.sync && r.onTransition(function(s) {
      i.send(se, { state: s, id: r.id });
    });
    var a = r;
    ...
    var i = yn(t, { id: n, parent: this });
    return this.children.set(n, i), i;
  }, e.prototype.spawnPromise = function(t, n) {
    var i, r = this, o = !1, a;
    t.then(function(c) {
      o || (a = c, r.removeChild(n), r.send(R(Et(n, c), { origin: n })));
    }, function(c) {
      if (!o) {
        r.removeChild(n);
        var u = ht(n, c);
    ...
    var i, r = this, o = !1, a = /* @__PURE__ */ new Set(), s = /* @__PURE__ */ new Set(), c, u = function(l) {
    ...
    var i, r = this, o, a = t.subscribe(function(c) {
      ...
      r.removeChild(n), r.send(R(ht(n, c), { origin: n }));
    }, function() {
      r.removeChild(n), r.send(R(Et(n), { origin: n }));
    ...
    if (this.options.devTools && t) {
      if (t.__REDUX_DEVTOOLS_EXTENSION__) {
        ...
        this.devTools = t.__REDUX_DEVTOOLS_EXTENSION__.connect(p(p({ name: this.id, autoPause: !0, stateSanitizer: function(i) {
          return { value: i.value, context: i.context, actions: i.actions };
        } }, n), { features: p({ jump: !1, skip: !1 }, n ? n.features : void 0) }), this.machine), this.devTools.init(this.state);
      }
      pn(this);
    }
  }, e.prototype.toJSON = function() {
    ...
    return this.status === C.NotStarted ? this.initialState : this._state;
  }, e.defaultOptions = { execute: !0, deferEvents: !0, clock: { setTimeout: function(t, n) {
    return setTimeout(t, n);
  }, clearTimeout: function(t) {
    return clearTimeout(t);
  } }, logger: console.log.bind(console), devTools: !1 }, e.interpret = Se, e;
}();
function Se(e, t) {
  var n = new mn(e, t);
  return n;
...
function _t(e) {
  return p(p({ type: Ct }, e), { toJSON: function() {
    e.onDone, e.onError;
    var t = qt(e, ["onDone", "onError"]);
    return p(p({}, t), { type: Ct, src: xn(e.src) });
  } });
}
var St = "", Ut = "#", Dt = "*", K = {}, tt = function(e) {
  return e[0] === Ut;
}, _n = function() {
  ...
  function e(t, n, i, r) {
    ...
    var o = this, a;
    this.config = t, this._context = i, this.order = -1, this.__xstatenode = !0, this.__cache = { events: void 0, relativeValue: /* @__PURE__ */ new Map(), initialStateValue: void 0, initialState: void 0, on: void 0, transitions: void 0, candidates: {}, delayedTransitions: void 0 }, this.idMap = {}, this.tags = [], this.options = Object.assign(_n(), n), this.parent = r == null ? void 0 : r.parent, this.key = this.config.key || (r == null ? void 0 : r.key) || this.config.id || "(machine)", this.machine = this.parent ? this.parent.machine : this, this.path = this.parent ? this.parent.path.concat(this.key) : [], this.delimiter = this.config.delimiter || (this.parent ? this.parent.delimiter : ce), this.id = this.config.id || V([this.machine.key], O(this.path), !1).join(this.delimiter), this.version = this.parent ? this.parent.version : this.config.version, this.type = this.config.type || (this.config.parallel ? "parallel" : this.config.states && Object.keys(this.config.states).length ? "compound" : this.config.history ? "history" : "atomic"), this.schema = this.parent ? this.machine.schema : (a = this.config.schema) !== null && a !== void 0 ? a : {}, this.description = this.config.description, this.initial = this.config.initial, this.states = this.config.states ? ut(this.config.states, function(u, h) {
    ...
    function c(u) {
      ...
      u.order = s++;
      try {
        for (var l = E(ge(u)), d = l.next(); !d.done; d = l.next()) {
          var y = d.value;
          c(y);
        }
      } catch (v) {
    ...
    c(this), this.history = this.config.history === !0 ? "shallow" : this.config.history || !1, this._transient = !!this.config.always || (this.config.on ? Array.isArray(this.config.on) ? this.config.on.some(function(u) {
      ...
      if (ot(u)) {
        var d = mt(o.id, h);
        return o.machine.options.services = p((f = {}, f[d] = u, f), o.machine.options.services), _t({ src: d, id: d });
      } else if (j(u.src)) {
        var d = u.id || mt(o.id, h);
        return _t(p(p({}, u), { id: d, src: u.src }));
      } else if (ot(u.src) || T(u.src)) {
        var d = u.id || mt(o.id, h);
        return o.machine.options.services = p((l = {}, l[d] = u.src, l), o.machine.options.services), _t(p(p({ id: d }, u), { src: d }));
      } else {
        var y = u.src;
        return _t(p(p({ id: mt(o.id, h) }, u), { src: y }));
      }
  ...
  return e.prototype._init = function() {
    this.__cache.transitions || me(this).forEach(function(t) {
      return t.on;
    });
  }, e.prototype.withConfig = function(t, n) {
    var i = this.options, r = i.actions, o = i.activities, a = i.guards, s = i.services, c = i.delays;
    return new e(this.config, { actions: p(p({}, r), t.actions), activities: p(p({}, o), t.activities), guards: p(p({}, a), t.guards), services: p(p({}, s), t.services), delays: p(p({}, c), t.delays) }, n ?? this.context);
  ...
  }, enumerable: !1, configurable: !0 }), Object.defineProperty(e.prototype, "definition", { get: function() {
    return { id: this.id, key: this.key, version: this.version, context: this.context, type: this.type, initial: this.initial, history: this.history, states: ut(this.states, function(t) {
      return t.definition;
    }), on: this.on, transitions: this.transitions, entry: this.onEntry, exit: this.onExit, activities: this.activities || [], meta: this.meta, order: this.order || -1, data: this.doneData, invoke: this.invoke, description: this.description, tags: this.tags };
  }, enumerable: !1, configurable: !0 }), e.prototype.toJSON = function() {
  ...
  }, enumerable: !1, configurable: !0 }), Object.defineProperty(e.prototype, "after", { get: function() {
    return this.__cache.delayedTransitions || (this.__cache.delayedTransitions = this.getDelayedTransitions(), this.__cache.delayedTransitions);
  }, enumerable: !1, configurable: !0 }), Object.defineProperty(e.prototype, "transitions", { get: function() {
    return this.__cache.transitions || (this.__cache.transitions = this.formatTransitions(), this.__cache.transitions);
  }, enumerable: !1, configurable: !0 }), e.prototype.getCandidates = function(t) {
    if (this.__cache.candidates[t])
      return this.__cache.candidates[t];
    var n = t === St, i = this.transitions.filter(function(r) {
      var o = r.eventType === t;
      return n ? o : o || r.eventType === Dt;
    });
    ...
    if (!n)
      return [];
    var i = function(o, a) {
      var s = T(o) ? "".concat(t.id, ":delay[").concat(a, "]") : o, c = tn(s, t.id);
      return t.onEntry.push(Qe(c, { delay: o })), t.onExit.push(He(c)), c;
    }, r = at(n) ? n.map(function(o, a) {
      var s = i(o.delay, a);
      return p(p({}, o), { event: s });
    }) : D(Object.keys(n).map(function(o, a) {
      var s = n[o], c = j(s) ? { target: s } : s, u = isNaN(+o) ? o : +o, h = i(u, a);
    ...
    return s.push.apply(s, V([], O(D(a.map(function(c) {
    ...
    var n = t instanceof F ? t : F.create(t), i = Array.from(lt([], this.getStateNodes(n.value)));
    return new F(p(p({}, n), { value: this.resolve(n.value), configuration: i, done: Ot(i, this), tags: ne(i), machine: this.machine }));
    ...
    var x = D(Object.keys(a).map(function(g) {
      return a[g].configuration;
    }));
    return { transitions: y, exitSet: D(d.map(function(g) {
      return g.exitSet;
    })), configuration: x, source: n, actions: D(Object.keys(a).map(function(g) {
      return a[g].actions;
    })) };
  }, e.prototype._transition = function(t, n, i) {
    return j(t) ? this.transitionLeafNode(t, n, i) : Object.keys(t).length === 1 ? this.transitionCompoundNode(t, n, i) : this.transitionParallelNode(t, n, i);
    ...
    try {
      for (var h = E(this.getCandidates(a)), f = h.next(); !f.done; f = h.next()) {
        var l = f.value, d = l.cond, y = l.in, v = t.context, x = y ? j(y) && tt(y) ? t.matches(dt(this.getStateNodeById(y).path, this.delimiter)) : Xt(dt(y, this.delimiter), De(this.path.slice(0, -2))(t.value)) : !0, g = !1;
        try {
          g = !d || de(this.machine, d, v, n, t);
        } catch (b) {
...
`).concat(b.message));
    ...
    if (u) {
      ...
      var m = D(c.map(function(b) {
        return o.getRelativeStateNodes(b, t.historyValue);
      })), _ = !!u.internal;
      return { transitions: [u], exitSet: _ ? [] : D(c.map(function(b) {
        return o.getPotentiallyReenteringNodes(b);
    ...
    var c, u, h, f, l = this, d = a ? lt([], this.getStateNodes(a.value)) : [], y = /* @__PURE__ */ new Set();
    try {
      for (var v = E(Array.from(t).sort(function(S, P) {
    ...
    try {
      for (var m = E(d), _ = m.next(); !_.done; _ = m.next()) {
        var g = _.value;
    ...
    i.exitSet.sort(function(S, P) {
      return P.order - S.order;
    });
    var b = Array.from(y).sort(function(S, P) {
      return S.order - P.order;
    }), A = new Set(i.exitSet), L = D(b.map(function(S) {
      var P = [];
      if (S.type !== "final")
        return P;
      var B = S.parent;
      if (!B.parent)
        return P;
      P.push(xt(S.id, S.doneData), xt(B.id, S.doneData ? Tt(S.doneData, r, o) : void 0));
      var $ = B.parent;
      return $.type === "parallel" && pt($).every(function(st) {
        return Ot(i.configuration, st);
      }) && P.push(xt($.id)), P;
    })), k = b.map(function(S) {
      var P = S.onEntry, B = S.activities.map(function($) {
        return Ye($);
      });
      return { type: "entry", actions: G(s ? V(V([], O(P), !1), O(B), !1) : V(V([], O(B), !1), O(P), !1), l.machine.options.actions) };
    }).concat({ type: "state_done", actions: L.map(function(S) {
      return Fe(S);
    }) }), I = Array.from(A).map(function(S) {
      return { type: "exit", actions: G(V(V([], O(S.onExit), !1), O(S.activities.map(function(P) {
        return Ze(P);
      })), !1), l.machine.options.actions) };
    }), w = I.concat({ type: "transition", actions: G(i.actions, this.machine.options.actions) }).concat(k);
    if (n) {
      var M = G(D(V([], O(t), !1).sort(function(S, P) {
        return P.order - S.order;
      }).map(function(S) {
        return S.onExit;
      })), this.machine.options.actions).filter(function(S) {
        return !$t(S);
      });
    ...
    if (t instanceof F)
      ...
      var s = j(t) ? this.resolve(kt(this.getResolvedPath(t))) : this.resolve(t), c = i ?? this.machine.context;
      a = this.resolveState(F.from(s, c));
    }
    if (this.strict && !this.events.includes(o.name) && !Ce(o.name))
      throw new Error("Machine '".concat(this.id, "' does not accept event '").concat(o.name, "'"));
    var u = this._transition(a.value, a, o) || { transitions: [], configuration: [], exitSet: [], source: a, actions: [] }, h = lt([], this.getStateNodes(a.value)), f = u.configuration.length ? lt(h, u.configuration) : h;
    ...
    var a, s, c, u, h = this;
    o === void 0 && (o = it);
    var f = t.configuration, l = !n || t.transitions.length > 0, d = l ? t.configuration : n ? n.configuration : [], y = Ot(d, this), v = l ? sn(this.machine, f) : void 0, x = n ? n.historyValue ? n.historyValue : t.source ? this.machine.historyValue(n.value) : void 0 : void 0, g = this.getActions(new Set(d), y, t, i, o, n, r), m = n ? p({}, n.activities) : {};
    try {
      for (var _ = E(g), b = _.next(); !b.done; b = _.next()) {
        var A = b.value;
        try {
          for (var L = (c = void 0, E(A.actions)), k = L.next(); !k.done; k = L.next()) {
            var I = k.value;
            I.type === Mt ? m[I.activity.id || I.activity.type] = I : I.type === Ft && (m[I.activity.id || I.activity.type] = !1);
          }
        } catch (J) {
          c = { error: J };
        } finally {
          try {
            k && !k.done && (u = L.return) && u.call(L);
          } finally {
            if (c)
              throw c.error;
          }
    ...
    var w = O(At(this, n, i, o, g, r, this.machine.config.predictableActionArguments || this.machine.config.preserveActionOrder), 2), M = w[0], S = w[1], P = O(Be(M, $t), 2), B = P[0], $ = P[1], st = M.filter(function(J) {
      var Y;
      return J.type === Mt && ((Y = J.activity) === null || Y === void 0 ? void 0 : Y.type) === Ct;
    }), gt = st.reduce(function(J, Y) {
      return J[Y.activity.id] = nn(Y.activity, h.machine, S, o), J;
    }, n ? p({}, n.children) : {}), q = new F({ value: v || n.value, context: S, _event: o, _sessionid: n ? n._sessionid : null, historyValue: v ? x ? $e(x, v) : void 0 : n ? n.historyValue : void 0, history: !v || t.source ? n : void 0, actions: v ? $ : [], activities: v ? m : n ? n.activities : {}, events: [], configuration: d, transitions: t.transitions, children: gt, done: y, tags: ne(d), machine: this }), W = i !== S;
    q.changed = o.name === se || W;
    var H = q.history;
    H && delete H.history;
    var Wt = !y && (this._transient || f.some(function(J) {
      return J._transient;
    }));
    if (!l && (!Wt || o.name === St))
      return q;
    var z = q;
    if (!y)
      for (Wt && (z = this.resolveRaisedTransition(z, { type: Ae }, o, r)); B.length; ) {
        var be = B.shift();
        z = this.resolveRaisedTransition(z, be._event, o, r);
      }
    var we = z.changed || (H ? !!z.actions.length || W || typeof H.value != typeof z.value || !_e(z.value, H.value) : void 0);
    return z.changed = we, z.history = H, z;
    ...
    var n = tt(t) ? t.slice(Ut.length) : t;
    if (n === this.id)
      return this;
    ...
    var n, i = this;
    if (!t)
      return this.initialStateValue || K;
    switch (this.type) {
      case "parallel":
        return ut(this.initialStateValue, function(o, a) {
          return o ? i.getStateNode(a).resolve(t[a] || o) : K;
        });
      case "compound":
        if (j(t)) {
        ...
        return Object.keys(t).length ? ut(t, function(o, a) {
          return o ? i.getStateNode(a).resolve(o) : K;
    ...
    if (this.type === "parallel")
      n = Kt(this.states, function(i) {
        return i.initialStateValue || K;
      }, function(i) {
  ...
  }, enumerable: !1, configurable: !0 }), e.prototype.getInitialState = function(t, n) {
    this._init();
  ...
  }, enumerable: !1, configurable: !0 }), Object.defineProperty(e.prototype, "target", { get: function() {
    var t;
    if (this.type === "history") {
      var n = this.config;
      j(n.target) ? t = tt(n.target) ? kt(this.machine.getStateNodeById(n.target).path.slice(this.path.length - 1)) : n.target : t = n.target;
    }
    return t;
  }, enumerable: !1, configurable: !0 }), e.prototype.getRelativeStateNodes = function(t, n, i) {
    ...
    if (this.type === "compound" && !this.initial)
      return [this];
    var n = bt(this.initialStateValue);
    return D(n.map(function(i) {
      return t.getFromRelativePath(i);
    }));
  }, enumerable: !1, configurable: !0 }), e.prototype.getFromRelativePath = function(t) {
    if (!t.length)
      return [this];
    ...
    if (Object.keys(this.states).length)
      return { current: t || this.initialStateValue, states: Kt(this.states, function(n, i) {
        if (!t)
          return n.historyValue();
        var r = j(t) ? void 0 : t[i];
    ...
    if (!t) {
      var r = this.target;
      return r ? D(bt(r).map(function(a) {
        return i.getFromRelativePath(a);
      })) : i.initialStateNodes;
    }
    var o = Me(i.path, "states")(t).current;
    return j(o) ? [i.getStateNode(o)] : D(bt(o).map(function(a) {
      return n.history === "deep" ? i.getFromRelativePath(a) : [i.states[a[0]]];
    }));
  }, Object.defineProperty(e.prototype, "stateIds", { get: function() {
    var t = this, n = D(Object.keys(this.states).map(function(i) {
      return t.states[i].stateIds;
    }));
    return [this.id].concat(n);
  }, enumerable: !1, configurable: !0 }), Object.defineProperty(e.prototype, "events", { get: function() {
    var t, n, i, r;
  ...
  }, enumerable: !1, configurable: !0 }), Object.defineProperty(e.prototype, "ownEvents", { get: function() {
    ...
    return Array.from(t);
  }, enumerable: !1, configurable: !0 }), e.prototype.resolveTarget = function(t) {
    var n = this;
    if (t !== void 0)
...
`).concat(s.message));
    ...
    var n = this, i = qe(t.target), r = "internal" in t ? t.internal : i ? i.some(function(c) {
      return j(c) && c[0] === n.delimiter;
    }) : !0, o = this.machine.options.guards, a = this.resolveTarget(i), s = p(p({}, t), { actions: G(U(t.actions)), cond: fe(t.cond, o), target: a, source: this, internal: r, eventType: t.event, toJSON: function() {
    ...
    if (!this.config.on)
      ...
      var o = this.config.on, a = Dt, s = o[a], c = s === void 0 ? [] : s, u = qt(o, [typeof a == "symbol" ? a : a + ""]);
      r = D(Object.keys(u).map(function(m) {
        var _ = Z(m, u[m]);
        return _;
      }).concat(Z(Dt, c)));
    }
    var h = this.config.always ? Z("", this.config.always) : [], f = this.config.onDone ? Z(String(xt(this.id)), this.config.onDone) : [], l = D(this.invoke.map(function(m) {
      var _ = [];
      return m.onDone && _.push.apply(_, V([], O(Z(String(Et(m.id)), m.onDone)), !1)), m.onError && _.push.apply(_, V([], O(Z(String(ht(m.id)), m.onError)), !1)), _;
    })), d = this.after, y = D(V(V(V(V([], O(f), !1), O(l), !1), O(r), !1), O(h), !1).map(function(m) {
      return U(m).map(function(_) {
        return i.formatTransition(_);
      });
    }));
    try {
      for (var v = E(d), x = v.next(); !x.done; x = v.next()) {
        var g = x.value;
        y.push(g);
      }
    } catch (m) {
...
var nt = { click: "onClick", mouseenter: "onMouseEnter", mouseleave: "onMouseLeave", complete: "onComplete", after: "onAfter", enter: "onEnter", show: "onShow" };
Object.values(nt);
var wn = Object.keys(nt), kn = class {
  constructor(e, t) {
    X(this, "activeStateId", "");
    X(this, "_service");
    X(this, "_domListeners", /* @__PURE__ */ new Map());
    X(this, "_domElement");
    X(this, "_playerListeners", /* @__PURE__ */ new Map());
    X(this, "_player");
    X(this, "_machineSchemas", /* @__PURE__ */ new Map());
  ...
  start(e) {
    ...
    if (typeof t > "u")
      throw It(`invalid state machine id ${e}`);
    this._service = Se(bn(t)), this._addEventListeners(), this._service.start();
  }
  stop() {
    var e;
    ...
    this._service.subscribe((n) => {
      ...
      if (typeof n.changed > "u" || n.changed) {
        ...
        for (let r of n.nextEvents)
          if (wn.filter((o) => o !== "complete" && o !== "show").includes(r)) {
            let o = t(r);
            this._domListeners.set(r, o), (i = this._domElement) == null || i.addEventListener(r, o, { once: !0 });
          } else if (r === "complete") {
            let o = t(r);
  ...
  _transformToXStateSchema(e) {
    ...
    for (let o of e) {
      ...
      if (s.id = o.descriptor.id, typeof o.descriptor.initial < "u" && (s.initial = o.descriptor.initial), typeof o < "u") {
        ...
        for (let u in c)
          if (typeof c[u] < "u" && c[u]) {
            let h = c[u], f = h.playbackSettings, l = Object.keys(h).filter((v) => v.startsWith("on")), d = {}, y = {};
            for (let v of l)
              if (typeof h[v] < "u") {
                let x = h[v];
                if (v === nt.after) {
                  let g = x;
                  y[g.ms] = { target: (t = x == null ? void 0 : x.state) != null ? t : "" };
                } else
                  v === nt.enter ? d[Ht(nt, v)] = { target: (n = x == null ? void 0 : x.state) != null ? n : "" } : d[Ht(nt, v)] = { target: (i = x == null ? void 0 : x.state) != null ? i : "" };
              }
            a[u] = { entry: () => {
              !this._player.getAnimationInstance() || h.animationId && h.animationId !== this._player.currentAnimationId ? this._player.play(h.animationId, () => ({ ...ke, ...f })).then(() => {
                this._updatePlaybackSettings(f);
              }).catch((v) => {
                Te(`State machine error: ${v.message}`);
              }) : this._updatePlaybackSettings(f);
            }, exit: () => {
  ...
  _handlePlaySegments(e) {
    if (typeof e.segments == "string")
      this._player.goToAndPlay(e.segments, !0);
    else {
  ...
  _requiresDomElement() {
    if (!this._domElement)
      throw It("Requires a DOM element to attach events.");
  }
};
...
*/
export {
  kn as DotLottieStateMachineManager
};
//# sourceMappingURL=dotlottie-state-machine-manager-7AXSPEV3-C4JS27KT-ec2009ec.js.map
