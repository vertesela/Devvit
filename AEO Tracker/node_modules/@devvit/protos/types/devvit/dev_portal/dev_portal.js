...
export class AppClientImpl {
    ...
    CheckIfMediaExists(request) {
        ...
        const promise = this.rpc.request(this.service, "CheckIfMediaExists", data);
        return promise.then((data) => CheckIfMediaExistsResponse.decode(new _m0.Reader(data)));
    }
    UploadNewMedia(request) {
        const data = UploadNewMediaRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "UploadNewMedia", data);
        return promise.then((data) => UploadNewMediaResponse.decode(new _m0.Reader(data)));
    }
    Update(request) {
    ...
    CreateAppAccount(request) {
        ...
        const promise = this.rpc.request(this.service, "CreateAppAccount", data);
        return promise.then((data) => CreateAppAccountResponse.decode(new _m0.Reader(data)));
    }
    RecoverAppAccount(request) {
        const data = RecoverAppAccountRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "RecoverAppAccount", data);
        return promise.then((data) => AppInfo.decode(new _m0.Reader(data)));
    }
}
...
export class AppVersionClientImpl {
    ...
    GetAppVersionBundle(request) {
        const data = UUID.encode(request).finish();
        const promise = this.rpc.request(this.service, "GetAppVersionBundle", data);
        return promise.then((data) => GetAppVersionBundleResponse.decode(new _m0.Reader(data)));
    }
    GetNutritionByNameVersion(request) {
        const data = GetNutritionByNameVersionRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "GetNutritionByNameVersion", data);
        return promise.then((data) => MultipleNutritionCategories.decode(new _m0.Reader(data)));
    }
    GetNutritionByAppVersionId(request) {
        const data = UUID.encode(request).finish();
        const promise = this.rpc.request(this.service, "GetNutritionByAppVersionId", data);
        return promise.then((data) => MultipleNutritionCategories.decode(new _m0.Reader(data)));
    }
}
...
export class InstallationsClientImpl {
    ...
    UpgradeMany(request) {
        ...
        const promise = this.rpc.request(this.service, "UpgradeMany", data);
        return promise.then((data) => InstallationUpgradeManyResponse.decode(new _m0.Reader(data)));
    }
    Update(request) {
...
export class DataApiAdminClientImpl {
    constructor(rpc, opts) {
        this.service = opts?.service || "devvit.dev_portal.DataApiAdmin";
        this.rpc = rpc;
    ...
    CreateDataToken(request) {
        ...
        const promise = this.rpc.request(this.service, "CreateDataToken", data);
        return promise.then((data) => CreateDataTokenResponse.decode(new _m0.Reader(data)));
    }
    ...
    RevokeDataTokenById(request) {
        ...
        const promise = this.rpc.request(this.service, "RevokeDataTokenById", data);
        return promise.then((data) => RevokeDataTokenByIdResponse.decode(new _m0.Reader(data)));
    }
    CreateDataSubscription(request) {
        const data = CreateDataSubscriptionRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "CreateDataSubscription", data);
        return promise.then((data) => CreateDataSubscriptionResponse.decode(new _m0.Reader(data)));
    }
    ...
    GetDataSubscriptionsByOrganizationName(request) {
        ...
        const promise = this.rpc.request(this.service, "GetDataSubscriptionsByOrganizationName", data);
        return promise.then((data) => GetDataSubscriptionsByOrganizationNameResponse.decode(new _m0.Reader(data)));
    }
    UpdateDataSubscription(request) {
        const data = UpdateDataSubscriptionRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "UpdateDataSubscription", data);
        return promise.then((data) => UpdateDataSubscriptionResponse.decode(new _m0.Reader(data)));
    }
    DeleteDataSubscription(request) {
        const data = DeleteDataSubscriptionRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "DeleteDataSubscription", data);
        return promise.then((data) => DeleteDataSubscriptionResponse.decode(new _m0.Reader(data)));
    }
    ...
    GetOrganizationByName(request) {
        ...
        const promise = this.rpc.request(this.service, "GetOrganizationByName", data);
        return promise.then((data) => GetOrganizationByNameResponse.decode(new _m0.Reader(data)));
    }
    ...
    GetAuditLogEvents(request) {
        ...
        const promise = this.rpc.request(this.service, "GetAuditLogEvents", data);
        return promise.then((data) => GetAuditLogEventsResponse.decode(new _m0.Reader(data)));
    }
}
...
export class DevPortalAppSettingsClientImpl {
    constructor(rpc, opts) {
        this.service = opts?.service || "devvit.dev_portal.DevPortalAppSettings";
        this.rpc = rpc;
        this.GetForm = this.GetForm.bind(this);
        this.ValidateForm = this.ValidateForm.bind(this);
        this.GetSettings = this.GetSettings.bind(this);
    ...
    GetForm(request) {
        ...
        const promise = this.rpc.request(this.service, "GetForm", data);
        return promise.then((data) => GetAppSettingsFormResponse.decode(new _m0.Reader(data)));
    }
    ValidateForm(request) {
        const data = ValidateAppSettingsFormRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "ValidateForm", data);
        return promise.then((data) => ValidateAppSettingsFormResponse.decode(new _m0.Reader(data)));
    }
    GetSettings(request) {
        const data = GetAppSettingsRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "GetSettings", data);
        return promise.then((data) => GetAppSettingsResponse.decode(new _m0.Reader(data)));
    }
    UpdateSettings(request) {
        const data = UpdateAppSettingsRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "UpdateSettings", data);
        return promise.then((data) => UpdateAppSettingsResponse.decode(new _m0.Reader(data)));
    }
}
