...
export class InternalDataApiAdminClientImpl {
    ...
    CreateFirehoseMonitorDataToken(request) {
        ...
        const promise = this.rpc.request(this.service, "CreateFirehoseMonitorDataToken", data);
    ...
    GetFirehoseMonitorSubscriptionByName(request) {
        ...
        const promise = this.rpc.request(this.service, "GetFirehoseMonitorSubscriptionByName", data);
        return promise.then((data) => GetFirehoseMonitorSubscriptionByNameResponse.decode(new _m0.Reader(data)));
    }
}
