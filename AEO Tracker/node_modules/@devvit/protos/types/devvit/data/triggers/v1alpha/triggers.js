...
export const TriggerEvent = {
    ...
    toJSON(message) {
        ...
        message.postCreate !== undefined &&
            (obj.postCreate = message.postCreate ? PostCreate.toJSON(message.postCreate) : undefined);
        ...
        message.postFlairUpdate !== undefined &&
            (obj.postFlairUpdate = message.postFlairUpdate ? PostFlairUpdate.toJSON(message.postFlairUpdate) : undefined);
        message.postDelete !== undefined &&
            (obj.postDelete = message.postDelete ? PostDelete.toJSON(message.postDelete) : undefined);
        ...
        message.commentCreate !== undefined &&
            (obj.commentCreate = message.commentCreate ? CommentCreate.toJSON(message.commentCreate) : undefined);
        ...
        message.commentDelete !== undefined &&
            (obj.commentDelete = message.commentDelete ? CommentDelete.toJSON(message.commentDelete) : undefined);
        ...
        message.modAction !== undefined &&
            (obj.modAction = message.modAction ? ModAction.toJSON(message.modAction) : undefined);
        message.modMail !== undefined && (obj.modMail = message.modMail ? ModMail.toJSON(message.modMail) : undefined);
        message.accountDelete !== undefined &&
            (obj.accountDelete = message.accountDelete ? AccountDelete.toJSON(message.accountDelete) : undefined);
        message.vote !== undefined && (obj.vote = message.vote ? Vote.toJSON(message.vote) : undefined);
        message.postApprove !== undefined &&
            (obj.postApprove = message.postApprove ? PostApprove.toJSON(message.postApprove) : undefined);
        message.commentApprove !== undefined &&
            (obj.commentApprove = message.commentApprove ? CommentApprove.toJSON(message.commentApprove) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseTriggerEvent();
