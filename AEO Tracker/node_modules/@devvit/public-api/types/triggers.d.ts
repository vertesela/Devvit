...
export type OnTriggerEvent<RequestType> = RequestType & {
    type: TriggerEvent;
};
export type TriggerContext = Omit<Devvit.Context, 'ui'>;
export type TriggerOnEventHandler<RequestType> = (event: OnTriggerEvent<RequestType>, context: TriggerContext) => TriggerResult;
