...
var _BlocksReconciler_instances, _BlocksReconciler_reset, _BlocksReconciler_makeContextProps, _BlocksReconciler_flatten;
...
export class BlocksReconciler {
    constructor(component, event, state, metadata) {
        ...
        this.transformer = new BlocksTransformer(this);
        this.effects = [];
    ...
    async processBlock(element, idGenerator = makeUniqueIdGenerator(), path = []) {
        ...
        if (typeof blockElement.type === 'function') {
            ...
            if (typeof result === 'object') {
                return this.processBlock(result, idGenerator, [
                    ...path,
                    blockElement.type.name,
                ]);
            }
        }
...
_BlocksReconciler_instances = new WeakSet(), _BlocksReconciler_reset = function _BlocksReconciler_reset() {
    this.actions.clear();
    this.currentComponentKey = [];
    this.currentHookIndex = 0;
    this.pendingHooks = [];
