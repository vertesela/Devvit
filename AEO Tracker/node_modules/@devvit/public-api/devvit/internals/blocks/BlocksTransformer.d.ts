...
import { BlocksReconciler, ReifiedBlockElement, ReifiedBlockElementOrLiteral } from './BlocksReconciler.js';
...
export declare class BlocksTransformer {
    ...
    makeBlockAnimationType(type: Devvit.Blocks.AnimationType): BlockAnimationType;
    ...
    makeActions(type: BlockType, props: Devvit.Blocks.Actionable): BlockAction[];
