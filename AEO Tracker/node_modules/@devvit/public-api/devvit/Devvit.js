...
export class Devvit extends Actor {
    ...
    static get schedulerPlugin() {
        ...
        if (!scheduler) {
            ...
            throw new Error('Scheduler is not enabled. You can enable it by passing `scheduler: true` to `Devvit.configure`');
        }
        return scheduler;
    }
    /** @internal */
    ...
    static get redisPlugin() {
        ...
        if (!redis) {
            throw new Error('Redis is not enable. You can enable it by passing `redis: true` to `Devvit.configure`');
        }
        return redis;
    }
    /** @internal */
