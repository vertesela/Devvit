...
import { BlockElement } from './internals/blocks/BlocksReconciler.js';
...
export declare namespace Devvit {
    ...
    namespace Blocks {
        ...
        interface HasElementChildren {
            children?: Devvit.ElementChildren;
        }
        interface HasStringChildren {
            children?: Devvit.StringChildren;
        }
        interface RootProps extends HasElementChildren {
            height?: Devvit.Blocks.RootHeight | undefined;
        }
        interface StackProps extends BaseProps, HasElementChildren, Actionable {
        ...
        interface TextProps extends BaseProps, HasStringChildren, Actionable {
            onClick?: string;
        ...
        interface ButtonProps extends BaseProps, HasStringChildren, Actionable {
            onClick?: string;
        ...
        interface ImageProps extends BaseProps, Actionable {
            url: string;
        ...
        interface IconProps extends BaseProps, HasStringChildren, Actionable {
            name: IconName;
            color?: ColorString | undefined;
            lightColor?: ColorString | undefined;
            darkColor?: ColorString | undefined;
        ...
        interface AvatarProps extends BaseProps, Actionable {
            thingId: string;
            facing?: AvatarFacing | undefined;
            size?: AvatarSize | undefined;
            background?: AvatarBackground | undefined;
        }
        interface FullSnooProps extends BaseProps, Actionable {
            userId: string;
            facing?: AvatarFacing | undefined;
            size?: FullSnooSize | undefined;
        }
        interface AnimationProps extends BaseProps, Actionable {
            url: string;
            imageWidth: SizePixels | number;
            imageHeight: SizePixels | number;
            type: AnimationType;
