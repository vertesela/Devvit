...
enum NutritionCategory {
  ...
  ASSETS = 2;
  // App may read and write _app_ data to Redit servers.
  DATA = 3;
  // App may read and write _any_ data to and from the internet.
  HTTP = 4;
  // App may read and write to Reddit moderator logs. Does not imply REDDIT_API.
  MODLOG = 5;
  ...
  SCHEDULER = 8;
  // App may appear in subreddit, post, and comment menus, and create custom
  // posts.
  UI = 9;
}
