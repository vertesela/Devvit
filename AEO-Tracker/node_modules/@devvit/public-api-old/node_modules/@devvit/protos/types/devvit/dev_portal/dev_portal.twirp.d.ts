...
export declare function createDataApiAdminServer<T extends TwirpContext = TwirpContext>(service: DataApiAdminTwirp<T>): TwirpServer<DataApiAdminTwirp<TwirpContext<import("http").IncomingMessage, import("http").ServerResponse>>, T>;
...
export declare function createDevPortalAppSettingsServer<T extends TwirpContext = TwirpContext>(service: DevPortalAppSettingsTwirp<T>): TwirpServer<DevPortalAppSettingsTwirp<TwirpContext<import("http").IncomingMessage, import("http").ServerResponse>>, T>;
