...
var B = (w, v, o) => v in w ? L(w, v, { enumerable: !0, configurable: !0, writable: !0, value: o }) : w[v] = o;
var M = (w, v, o) => (B(w, typeof v != "symbol" ? v + "" : v, o), o);
import { v as D, u as G } from "./chunk-HDDX7F4A-86b3392d.js";
var E = G((w) => {
  (function() {
    var v = function() {
      this.init();
    ...
    v.prototype = { init: function() {
      ...
      var n = this || o;
      if (e = parseFloat(e), n.ctx || g(), typeof e < "u" && e >= 0 && e <= 1) {
        ...
        for (var t = 0; t < n._howls.length; t++)
          if (!n._howls[t]._webAudio)
            for (var r = n._howls[t]._getSoundIds(), s = 0; s < r.length; s++) {
              var _ = n._howls[t]._soundById(r[s]);
      ...
      for (var e = this || o, n = e._howls.length - 1; n >= 0; n--)
        e._howls[n].unload();
      return e.usingWebAudio && e.ctx && typeof e.ctx.close < "u" && (e.ctx.close(), e.ctx = null, g()), e;
    }, codecs: function(e) {
        ...
        var n = function(t) {
          ...
          for (var s = 0; s < e._howls.length; s++)
            if (!e._howls[s]._webAudio)
              for (var _ = e._howls[s]._getSoundIds(), a = 0; a < _.length; a++) {
                var l = e._howls[s]._soundById(_[a]);
    ...
    u.prototype = { init: function(e) {
      ...
      if (typeof e == "number")
        ...
        if (typeof e > "u" && (e = "__default", !t._playLock)) {
          for (var s = 0, _ = 0; _ < t._sounds.length; _++)
            t._sounds[_]._paused && !t._sounds[_]._ended && (s++, r = t._sounds[_]._id);
          s === 1 ? e = null : r = null;
        }
      }
      ...
      var m = Math.max(0, a._seek > 0 ? a._seek : t._sprite[e][0] / 1e3), A = Math.max(0, (t._sprite[e][0] + t._sprite[e][1]) / 1e3 - m), b = A * 1e3 / Math.abs(a._rate), T = t._sprite[e][0] / 1e3, S = (t._sprite[e][0] + t._sprite[e][1]) / 1e3;
      a._sprite = e, a._ended = !1;
      var k = function() {
        a._paused = !1, a._seek = m, a._start = T, a._stop = S, a._loop = !!(a._loop || t._sprite[e][2]);
      };
      if (m >= S) {
        t._ended(a);
        return;
      ...
      if (t._webAudio) {
        var I = function() {
          ...
          var x = a._muted || t._muted ? 0 : a._volume;
          h.gain.setValueAtTime(x, o.ctx.currentTime), a._playStart = o.ctx.currentTime, typeof h.bufferSource.start > "u" ? a._loop ? h.bufferSource.noteGrainOn(0, m, 86400) : h.bufferSource.noteGrainOn(0, m, A) : a._loop ? h.bufferSource.start(0, m, 86400) : h.bufferSource.start(0, m, A), b !== 1 / 0 && (t._endTimers[a._id] = setTimeout(t._ended.bind(t, a), b)), n || setTimeout(function() {
        ...
        var H = function() {
          ...
          try {
            var x = h.play();
            if (x && typeof Promise < "u" && (x instanceof Promise || typeof x.then == "function") ? (t._playLock = !0, k(), x.then(function() {
            ...
            e !== "__default" || a._loop ? t._endTimers[a._id] = setTimeout(t._ended.bind(t, a), b) : (t._endTimers[a._id] = function() {
              t._ended(a), h.removeEventListener("ended", t._endTimers[a._id], !1);
            }, h.addEventListener("ended", t._endTimers[a._id], !1));
          } catch (F) {
            t._emit("playerror", a._id, F);
          }
        };
        h.src === "data:audio/wav;base64,UklGRigAAABXQVZFZm10IBIAAAABAAEARKwAAIhYAQACABAAAABkYXRhAgAAAAEA" && (h.src = t._src, h.load());
        var P = window && window.ejecta || !h.readyState && o._navigator.isCocoonJS;
        if (h.readyState >= 3 || P)
          H();
        else {
          t._playLock = !0, t._state = "loading";
          var O = function() {
            t._state = "loaded", H(), h.removeEventListener(o._canPlayEvent, O, !1);
          };
          h.addEventListener(o._canPlayEvent, O, !1), t._clearTimer(a._id);
        }
      }
      return a._id;
    }, pause: function(e) {
      ...
      for (var r = t._getSoundIds(e), s = 0; s < r.length; s++) {
        t._clearTimer(r[s]);
        var _ = t._soundById(r[s]);
        _ && (_._seek = _._start || 0, _._rateSeek = 0, _._paused = !0, _._ended = !0, t._stopFade(r[s]), _._node && (t._webAudio ? _._node.bufferSource && (typeof _._node.bufferSource.stop > "u" ? _._node.bufferSource.noteOff(0) : _._node.bufferSource.stop(0), t._cleanBuffer(_._node)) : (!isNaN(_._node.duration) || _._node.duration === 1 / 0) && (_._node.currentTime = _._start || 0, _._node.pause(), _._node.duration === 1 / 0 && t._clearSound(_._node))), n || t._emit("stop", _._id));
      }
      return t;
    }, mute: function(e, n) {
      var t = this;
      ...
      for (var r = t._getSoundIds(n), s = 0; s < r.length; s++) {
        var _ = t._soundById(r[s]);
        _ && (_._muted = e, _._interval && t._stopFade(_._id), t._webAudio && _._node ? _._node.gain.setValueAtTime(e ? 0 : _._volume, o.ctx.currentTime) : _._node && (_._node.muted = o._muted ? !0 : e), t._emit("mute", _._id));
      }
      return t;
    }, volume: function() {
      ...
      if (n.length === 1 || n.length === 2 && typeof n[1] > "u") {
        var s = e._getSoundIds(), _ = s.indexOf(n[0]);
        _ >= 0 ? r = parseInt(n[0], 10) : t = parseFloat(n[0]);
      } else
      ...
      for (var _ = s._getSoundIds(r), a = 0; a < _.length; a++) {
        var l = s._soundById(_[a]);
        if (l) {
          if (r || s._stopFade(_[a]), s._webAudio && !l._muted) {
            var m = o.ctx.currentTime, A = m + t / 1e3;
            l._volume = e, l._node.gain.setValueAtTime(e, m), l._node.gain.linearRampToValueAtTime(n, A);
          }
          s._startFadeInterval(l, e, n, t, _[a], typeof r > "u");
        }
      }
      return s;
    }, _startFadeInterval: function(e, n, t, r, s, _) {
      var a = this, l = n, m = t - n, A = Math.abs(m / 0.01), b = Math.max(4, A > 0 ? r / A : r), T = Date.now();
      e._fadeTo = t, e._interval = setInterval(function() {
        var S = (Date.now() - T) / r;
        T = Date.now(), l += m * S, l = Math.round(l * 100) / 100, m < 0 ? l = Math.max(t, l) : l = Math.min(t, l), a._webAudio ? e._volume = l : a.volume(l, e._id, !0), _ && (a._volume = l), (t < n && l <= t || t > n && l >= t) && (clearInterval(e._interval), e._interval = null, e._fadeTo = null, a.volume(t, e._id), a._emit("fade", e._id));
      }, b);
      ...
      if (n.length === 1)
        if (typeof n[0] == "boolean")
          ...
          return s = e._soundById(parseInt(n[0], 10)), s ? s._loop : !1;
      else
        n.length === 2 && (t = n[0], r = parseInt(n[1], 10));
      for (var _ = e._getSoundIds(r), a = 0; a < _.length; a++)
        s = e._soundById(_[a]), s && (s._loop = t, e._webAudio && s._node && s._node.bufferSource && (s._node.bufferSource.loop = t, t && (s._node.bufferSource.loopStart = s._start || 0, s._node.bufferSource.loopEnd = s._stop, e.playing(_[a]) && (e.pause(_[a], !0), e.play(_[a], !0)))));
      return e;
    }, rate: function() {
      var e = this, n = arguments, t, r;
      if (n.length === 0)
      ...
      if (typeof t == "number") {
        ...
        for (var l = 0; l < r.length; l++)
          if (a = e._soundById(r[l]), a) {
            ...
            var m = e.seek(r[l]), A = (e._sprite[a._sprite][0] + e._sprite[a._sprite][1]) / 1e3 - m, b = A * 1e3 / Math.abs(a._rate);
            (e._endTimers[r[l]] || !a._paused) && (e._clearTimer(r[l]), e._endTimers[r[l]] = setTimeout(e._ended.bind(e, a), b)), e._emit("rate", a._id);
          }
      } else
      ...
      if (n.length === 0)
        ...
        var s = e._getSoundIds(), _ = s.indexOf(n[0]);
        _ >= 0 ? r = parseInt(n[0], 10) : e._sounds.length && (r = e._sounds[0]._id, t = parseFloat(n[0]));
      } else
        n.length === 2 && (t = parseFloat(n[0]), r = parseInt(n[1], 10));
      if (typeof r > "u")
        return 0;
      ...
      if (a)
        if (typeof t == "number" && t >= 0) {
          ...
          var b = e.playing(r) ? o.ctx.currentTime - a._playStart : 0, T = a._rateSeek ? a._rateSeek - a._seek : 0;
      ...
      for (var e = this, n = e._sounds, t = 0; t < n.length; t++)
        n[t]._paused || e.stop(n[t]._id), e._webAudio || (e._clearSound(n[t]._node), n[t]._node.removeEventListener("error", n[t]._errorFn, !1), n[t]._node.removeEventListener(o._canPlayEvent, n[t]._loadFn, !1), n[t]._node.removeEventListener("ended", n[t]._endFn, !1), o._releaseHtml5Audio(n[t]._node)), delete n[t]._node, e._clearTimer(n[t]._id);
      ...
      var s = this, _ = s["_on" + e];
      return typeof n == "function" && _.push(r ? { id: t, fn: n, once: r } : { id: t, fn: n }), s;
    }, off: function(e, n, t) {
      var r = this, s = r["_on" + e], _ = 0;
      if (typeof n == "number" && (t = n, n = null), n || t)
        ...
        for (_ = 0; _ < l.length; _++)
          l[_].indexOf("_on") === 0 && Array.isArray(r[l[_]]) && (r[l[_]] = []);
      }
      return r;
    }, once: function(e, n, t) {
      var r = this;
      ...
      for (var r = this, s = r["_on" + e], _ = s.length - 1; _ >= 0; _--)
        (!s[_].id || s[_].id === n || e === "load") && (setTimeout((function(a) {
          a.call(this, n, t);
        }).bind(r, s[_].fn), 0), s[_].once && r.off(e, s[_].fn, s[_].id));
    ...
    i.prototype = { init: function() {
      ...
      var e = this, n = e._parent;
      n._duration = Math.ceil(e._node.duration * 10) / 10, Object.keys(n._sprite).length === 0 && (n._sprite = { __default: [0, n._duration * 1e3] }), n._state !== "loaded" && (n._state = "loaded", n._emit("load"), n._loadQueue()), e._node.removeEventListener(o._canPlayEvent, e._loadFn, !1);
    ...
    var p = {}, c = function(e) {
      ...
      if (/^data:[^;]+;base64,/.test(n)) {
        ...
        _.open(e._xhr.method, n, !0), _.withCredentials = e._xhr.withCredentials, _.responseType = "arraybuffer", e._xhr.headers && Object.keys(e._xhr.headers).forEach(function(a) {
      ...
      var t = function() {
        ...
        s && n._sounds.length > 0 ? (p[n._src] = s, d(n, s)) : t();
      };
    ...
    typeof define == "function" && define.amd && define([], function() {
      return { Howler: o, Howl: u };
    }), typeof w < "u" && (w.Howler = o, w.Howl = u), typeof global < "u" ? (global.HowlerGlobal = v, global.Howler = o, global.Howl = u, global.Sound = i) : typeof window < "u" && (window.HowlerGlobal = v, window.Howler = o, window.Howl = u, window.Sound = i);
  })(), function() {
    HowlerGlobal.prototype._pos = [0, 0, 0], HowlerGlobal.prototype._orientation = [0, 0, -1, 0, 1, 0], HowlerGlobal.prototype.stereo = function(o) {
      ...
      if (!p.ctx || !p.ctx.listener)
        return p;
      if (u = typeof u != "number" ? p._pos[1] : u, i = typeof i != "number" ? p._pos[2] : i, typeof o == "number")
        p._pos = [o, u, i], typeof p.ctx.listener.positionX < "u" ? (p.ctx.listener.positionX.setTargetAtTime(p._pos[0], Howler.ctx.currentTime, 0.1), p.ctx.listener.positionY.setTargetAtTime(p._pos[1], Howler.ctx.currentTime, 0.1), p.ctx.listener.positionZ.setTargetAtTime(p._pos[2], Howler.ctx.currentTime, 0.1)) : p.ctx.listener.setPosition(p._pos[0], p._pos[1], p._pos[2]);
      else
        return p._pos;
      return p;
      ...
      if (u = typeof u != "number" ? d[1] : u, i = typeof i != "number" ? d[2] : i, p = typeof p != "number" ? d[3] : p, c = typeof c != "number" ? d[4] : c, y = typeof y != "number" ? d[5] : y, typeof o == "number")
        f._orientation = [o, u, i, p, c, y], typeof f.ctx.listener.forwardX < "u" ? (f.ctx.listener.forwardX.setTargetAtTime(o, Howler.ctx.currentTime, 0.1), f.ctx.listener.forwardY.setTargetAtTime(u, Howler.ctx.currentTime, 0.1), f.ctx.listener.forwardZ.setTargetAtTime(i, Howler.ctx.currentTime, 0.1), f.ctx.listener.upX.setTargetAtTime(p, Howler.ctx.currentTime, 0.1), f.ctx.listener.upY.setTargetAtTime(c, Howler.ctx.currentTime, 0.1), f.ctx.listener.upZ.setTargetAtTime(y, Howler.ctx.currentTime, 0.1)) : f.ctx.listener.setOrientation(o, u, i, p, c, y);
      else
        return d;
      return f;
      ...
      return function(u) {
        var i = this;
        return i._orientation = u.orientation || [1, 0, 0], i._stereo = u.stereo || null, i._pos = u.pos || null, i._pannerAttr = { coneInnerAngle: typeof u.coneInnerAngle < "u" ? u.coneInnerAngle : 360, coneOuterAngle: typeof u.coneOuterAngle < "u" ? u.coneOuterAngle : 360, coneOuterGain: typeof u.coneOuterGain < "u" ? u.coneOuterGain : 0, distanceModel: typeof u.distanceModel < "u" ? u.distanceModel : "inverse", maxDistance: typeof u.maxDistance < "u" ? u.maxDistance : 1e4, panningModel: typeof u.panningModel < "u" ? u.panningModel : "HRTF", refDistance: typeof u.refDistance < "u" ? u.refDistance : 1, rolloffFactor: typeof u.rolloffFactor < "u" ? u.rolloffFactor : 1 }, i._onstereo = u.onstereo ? [{ fn: u.onstereo }] : [], i._onpos = u.onpos ? [{ fn: u.onpos }] : [], i._onorientation = u.onorientation ? [{ fn: u.onorientation }] : [], o.call(this, u);
      };
      ...
      for (var y = c._getSoundIds(p), f = 0; f < y.length; f++) {
        var d = c._soundById(y[f]);
        if (d)
          if (typeof o == "number")
            d._pos = [o, u, i], d._node && ((!d._panner || d._panner.pan) && v(d, "spatial"), typeof d._panner.positionX < "u" ? (d._panner.positionX.setValueAtTime(o, Howler.ctx.currentTime), d._panner.positionY.setValueAtTime(u, Howler.ctx.currentTime), d._panner.positionZ.setValueAtTime(i, Howler.ctx.currentTime)) : d._panner.setPosition(o, u, i)), c._emit("pos", d._id);
          else
            return d._pos;
      }
      return c;
      ...
      for (var y = c._getSoundIds(p), f = 0; f < y.length; f++) {
        ...
        if (d)
          if (typeof o == "number")
            d._orientation = [o, u, i], d._node && (d._panner || (d._pos || (d._pos = c._pos || [0, 0, -0.5]), v(d, "spatial")), typeof d._panner.orientationX < "u" ? (d._panner.orientationX.setValueAtTime(o, Howler.ctx.currentTime), d._panner.orientationY.setValueAtTime(u, Howler.ctx.currentTime), d._panner.orientationZ.setValueAtTime(i, Howler.ctx.currentTime)) : d._panner.setOrientation(o, u, i)), c._emit("orientation", d._id);
          else
...
//# sourceMappingURL=dotlottie-audio-75C54RUV-3709e1ea.js.map
