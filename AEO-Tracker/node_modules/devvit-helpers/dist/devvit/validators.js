 ...
 */
export async function validateMultiple(validators, event, context, errorMessage) {
 ...
 */
export async function validateCustomDateformat(event, _context, errorMessage = ERRORS.INVALID_DATE_TEMPLATE) {
 ...
 * @returns The error message if the validation fails, or undefined if it passes.
 */
export async function validateCustomTimezone(event, _context, errorMessage = ERRORS.INVALID_TIMEZONE) {
 ...
 * @returns The error message if the validation fails, or undefined if it passes.
 */
export async function validateCustomLocale(event, _context, errorMessage = ERRORS.INVALID_LOCALE) {
 ...
 */
export async function validatePositiveInteger(event, _context, errorMessage = ERRORS.NOT_POSITIVE_INTEGER) {
 ...
 */
export async function validatePositiveNumber(event, _context, errorMessage = ERRORS.NOT_POSITIVE) {
    const value = Number(event?.value);
 ...
 * @returns The error message if the validation fails, or undefined if it passes.
 */
export async function validatePositive(event, _context, errorMessage = ERRORS.NOT_POSITIVE) {
    const value = Number(event?.value);
    if (isNaN(value) || value < 0) {
        return errorMessage;
    }
 ...
 * @returns
 */
export async function validateNegative(event, _context, errorMessage = ERRORS.NOT_NEGATIVE) {
    const value = Number(event?.value);
    if (isNaN(value) || value >= 0) {
        return errorMessage;
    }
 ...
 * @returns The error message if the validation fails, or undefined if it passes.
 */
export async function validateInteger(event, _context, errorMessage = ERRORS.NOT_INTEGER) {
    const value = Number(event?.value);
 ...
 * @returns The error message if the validation fails, or undefined if it passes.
 */
export async function validateNonZero(event, _context, errorMessage = ERRORS.NOT_NONZERO) {
    const value = Number(event?.value);
    if (isNaN(value) || value === 0) {
        return errorMessage;
    }
 ...
 * @returns The error message if the validation fails, or undefined if it passes.
 */
export async function validateFinite(event, _context, errorMessage = ERRORS.NOT_FINITE) {
    const value = Number(event?.value);
 ...
 * @returns The error message if the validation fails, or undefined if it passes.
 */
export async function validateNumber(event, _context, errorMessage = ERRORS.NOT_NUMBER) {
    const value = Number(event?.value);
    if (isNaN(value)) {
        return errorMessage;
    }
 ...
 * @returns The error message if the validation fails, or undefined if it passes.
 */
export async function validateUsernameList(event, _context, errorMessage = ERRORS.USERNAMECSV_INVALID, errorMessagePrefix = ERRORS.USERNAMECSV_PREFIXED, errorMessageSpace = ERRORS.NO_SPACES, errorMessageTrailing = ERRORS.NO_TRAILING_COMMA) {
 ...
 * @returns The error message if the validation fails, or undefined if it passes.
 */
export async function validateSubredditNameList(event, _context, errorMessage = ERRORS.SUBNAMECSV_INVALID, errorMessagePrefix = ERRORS.SUBNAMECSV_PREFIXED, errorMessageSpace = ERRORS.NO_SPACES, errorMessageTrailing = ERRORS.NO_TRAILING_COMMA) {
 ...
 * @returns The error message if the validation fails, or undefined if it passes.
 */
export async function validateUsername(event, _context, errorMessage = ERRORS.USERNAME_INVALID, errorMessagePrefix = ERRORS.USERNAME_PREFIXED, errorMessageSpace = ERRORS.NO_SPACES, errorMessageComma = ERRORS.NO_COMMA) {
 ...
 * @returns The error message if the validation fails, or undefined if it passes.
 */
export async function validateSubredditName(event, _context, errorMessage = ERRORS.SUBNAME_INVALID, errorMessagePrefix = ERRORS.SUBNAME_PREFIXED, errorMessageSpace = ERRORS.NO_SPACES, errorMessageComma = ERRORS.NO_COMMA) {
